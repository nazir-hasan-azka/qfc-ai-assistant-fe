    ...
    <div className="relative min-h-screen w-full bg-[#F5F5F5]">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-xs text-gray-400">email.3101483@email.com</span>
      ...
      <main className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        {/* Info Banner */}
        <div className="bg-[#F0F0F0] border-x border-gray-200 px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
      ...
      {/* ==================== Floating Chat Widget (Three States) ==================== */}
      <ChatInterface />
    </div>
  )
}
